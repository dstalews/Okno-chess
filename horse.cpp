...
int Horse::validate(int row, int col, int checker)
{
    ...
    if(r-2>=0 && c-1>=0)
    {
        if(chess->getTile(r-2,c-1)->getPieceObject()==nullptr || chess->getTile(r-2,c-1)->getPieceObject()->getPieceColor()!=this->pieceColor)
        {
            if(checker)
            {
            ...
            if (!wcheck)
            {
                chess->newExp(chess->getTile(r-2,c-1)->getTileNum());
                retVal=1;
            }
        }
        else
    ...
    if(r-1>=0 && c-2>=0)
    {
        if(chess->getTile(r-1,c-2)->getPieceObject()==nullptr||chess->getTile(r-1,c-2)->getPieceObject()->getPieceColor()!=this->pieceColor)
        {
            if(checker)
            {
            ...
            if (!wcheck)
            {
                chess->newExp(chess->getTile(r-1,c-2)->getTileNum());
                retVal=1;
            }
        }
        else
